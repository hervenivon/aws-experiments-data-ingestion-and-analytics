...
export class DataExperimentStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    const bidrequestsData = new S3Asset(this, 'BidRequestsData', {
      path: path.join(basePath, 'data', 'bidrequests.txt')
    });
    // End of Assets to upload
    ...
    taskDefinition.addContainer('AppContainer', {
      ...
      environment: { // clear text, not for sensitive data
        BIDREQUESTSDATA: bidrequestsData.s3Url,
      },
    });
